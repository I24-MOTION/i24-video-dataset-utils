...
# set reinterpolation parameters
eval_stride = 1/10


# load tracking results
# track_data_path = "/home/worklab/Documents/i24/fast-trajectory-annotator/tracking/results_ORACLE_10Hz.cpkl"
# with open(track_data_path,"rb") as f:
#     tracklets = pickle.load(f)
#     tracklets2 = []
#     for key in tracklets:
#           if len(tracklets[key]) > 0:
#               tracklets2.append([tracklets[key]])
#     tracklets = tracklets2

track_data_path = "/home/worklab/Documents/i24/fast-trajectory-annotator/tracking/results_SORT_10Hz.cpkl"
with open(track_data_path,"rb") as f:
      _,tracklets = pickle.load(f)


# load GPS file
#gps = "./data/GPS_10hz_smooth_CORRECTED.cpkl"
gps = "./data/GPS_NEWHG_CORRECTED.cpkl"
...
with open("./results/{}".format(track_data_path.split("/")[-1]),"wb") as f:
